...
| app/components/EvidenceUpload.tsx | AI-generated document-evidence upload component (file to base64 in browser, POST /api/evidence/verify, verified/not-verified states), human-reviewed |
